...
All benchmarks run on Apple M1 Max with Go 1.25 and Python 3.14. [Run them yourself →](https://github.com/zap-proto/benchmarks)
...
git clone https://github.com/zap-proto/benchmarks
cd benchmarks
...
See the [benchmark repository](https://github.com/zap-proto/benchmarks) for full methodology and reproducible results.
