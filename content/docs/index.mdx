...
<Cards>
  ...
  <Card title="Protocol" href="/docs/protocol">
    The wire format and schema language
  </Card>
  <Card title="Why ZAP?" href="/docs/why-zap">
    What ZAP replaces, and the stack that proves it
  </Card>
  <Card title="Full Documentation" href="https://zap-proto.dev/docs">
    SDKs, protocols, tools, and benchmarks on zap-proto.dev
  </Card>
</Cards>
