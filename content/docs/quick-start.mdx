...
```bash
# Install the ZAP CLI
go install github.com/zap-proto/spec/cmd/zap@latest
```
</Tab>
<Tab value="Rust">
```bash
...
```bash
# Install packages
npm install @zap-proto/zap @zap-proto/codegen

# Or with pnpm
pnpm add @zap-proto/zap @zap-proto/codegen
```
</Tab>
</Tabs>
...
<Tab value="TypeScript">
```typescript
import { createServer } from '@zap-proto/zap';
...
<Tab value="TypeScript">
```typescript
import { createClient } from '@zap-proto/zap';
